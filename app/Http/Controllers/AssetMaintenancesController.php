...
class AssetMaintenancesController extends Controller
{
    ...
    public function create(): View
    {
        ...
        $pirorities = Priority::pluck('name', 'id');
        $failureTypes = FailureType::pluck('name', 'id');

        return view('asset_maintenances/edit')
            ->with('asset', $asset)
            ->with('assetMaintenanceType', $assetMaintenanceType)
            ->with('item', new AssetMaintenance)
            ->with('pirorities', $pirorities)
            ->with('failureTypes', $failureTypes);
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $assetMaintenance->pirority_id = $request->input('pirority_id');
        $assetMaintenance->failure_type_id = $request->input('failure_type_id');
