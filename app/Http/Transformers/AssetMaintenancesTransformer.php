...
class AssetMaintenancesTransformer
{
    ...
    public function transformAssetMaintenance(AssetMaintenance $assetmaintenance)
    {
        $array = [
            ...
            'failureType' => $assetmaintenance->failureType ? [
                'id' => $assetmaintenance->failureType->id,
                'name' => e($assetmaintenance->failureType->name),
            ] : null,
            'pirority' => $assetmaintenance->pirority ? [
                'id' => $assetmaintenance->pirority->id,
                'name' => e($assetmaintenance->pirority->name),
            ] : null,
